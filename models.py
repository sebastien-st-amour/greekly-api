...
class OptionsQuotes(GreeklyModel):
    ...
    broker_id = db.Column(db.Integer, unique=True)
    bid_price = db.Column(db.Numeric(precision=2), nullable=True)
    bid_size = db.Column(db.Integer, default=0)
    ask_price = db.Column(db.Numeric(precision=2), nullable=True)
    ask_size = db.Column(db.Integer, default=0)
    last_trade_price_tr_hrs = db.Column(db.Numeric(precision=2), nullable=True)
    last_trade_price = db.Column(db.Numeric(precision=2), nullable=True)
    ...
    open_price = db.Column(db.Numeric(precision=2), nullable=True)
    high_price = db.Column(db.Numeric(precision=2), nullable=True)
    low_price = db.Column(db.Numeric(precision=2), nullable=True)
    volatility = db.Column(db.Numeric(precision=6), nullable=True)
    delta = db.Column(db.Numeric(precision=6), nullable=True)
    gamma = db.Column(db.Numeric(precision=6), nullable=True)
    theta = db.Column(db.Numeric(precision=6), nullable=True)
    vega = db.Column(db.Numeric(precision=6), nullable=True)
    rho = db.Column(db.Numeric(precision=6), nullable=True)
    open_interest = db.Column(db.Integer, default=0)
    delay = db.Column(db.Integer, default=0)
    is_halted = db.Column(db.Boolean)
    vwap = db.Column(db.Numeric(precision=2), nullable=True)
